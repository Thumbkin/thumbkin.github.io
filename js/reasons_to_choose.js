class ReasonsToChoose {
    static NONE = new ReasonsToSwap('Vorige proces wordt verder uitgevoerd');
    static NO_PROCESS_AVAILABLE = new ReasonsToSwap('Geen proces beschikbaar ter uitvoering');
